...
Engine: **Engine v1.4.3** (v1.4 + the Grade 7 back-port, 2026-07-04 — the two grade hubs are at engine parity; improve in one place, re-propagate deliberately). Additional invariants:
